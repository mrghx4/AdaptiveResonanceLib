...
from artlib.optimized.backends.cpp.cppEllipsoidART import FitEllipsoidART, PredictEllipsoidART


class EllipsoidART(pyEllipsoidART):
    """EllipsoidART for Clustering. optimized with C++"""
