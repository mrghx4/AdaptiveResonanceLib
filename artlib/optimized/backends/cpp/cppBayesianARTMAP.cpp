...
public:
    ...
    ) : params_{rho, parse_cov_init(cov_init), std::move(MT), epsilon} {
    ...
    fit(XArray X, YArray y) {
        ...
        artlib_cpp::BayesianARTMAPCore core(params_);
...
auto FitBayesianARTMAP(
    ...
    cppBayesianARTMAP model(rho, cov_init, MT, epsilon, weights, cluster_labels);
    return model.fit(X, y);
}

auto PredictBayesianARTMAP(
    XArray X,
    double rho,
    XArray cov_init,
    const std::string& MT,
...
PYBIND11_MODULE(cppBayesianARTMAP, m) {
    py::class_<cppBayesianARTMAP>(m, "cppBayesianARTMAP")
        .def(
            py::init<double, XArray, std::string, double, py::object, py::object>(),
            py::arg("rho"),
            py::arg("cov_init"),
            py::arg("MT"),
            py::arg("epsilon"),
        ...
        .def("fit", &cppBayesianARTMAP::fit, py::arg("X"), py::arg("y"))
        .def("predict", &cppBayesianARTMAP::predict, py::arg("X"))
        .def("__repr__", [](const cppBayesianARTMAP&) { return "<cppBayesianARTMAP>"; });
