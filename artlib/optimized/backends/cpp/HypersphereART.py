"""Hypersphere ART :cite:`anagnostopoulos2000hypersphere`."""
...
from artlib.optimized.backends.cpp.cppHypersphereART import (
    FitHypersphereART,
    PredictHypersphereART,
)


class HypersphereART(pyHypersphereART):
    """HypersphereART for Clustering. optimized with C++"""
    ...
    def fit(
        ...
        la, W = FitHypersphereART(
            X_,
            rho=self.params["rho"],
            alpha=self.params["alpha"],
            beta=self.params["beta"],
            r_hat=self.params["r_hat"],
            weights=None,
        )
