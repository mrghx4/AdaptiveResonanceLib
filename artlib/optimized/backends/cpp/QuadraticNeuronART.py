"""Quadratic Neuron ART optimized backend using C++."""
...
from artlib.optimized.backends.cpp.cppQuadraticNeuronART import (
    FitQuadraticNeuronART,
    PredictQuadraticNeuronART,
)


class QuadraticNeuronART(pyQuadraticNeuronART):
    """QuadraticNeuronART for clustering, optimized with C++."""
    ...
    def fit(
        ...
        la, W = FitQuadraticNeuronART(
            X_,
            rho=self.params["rho"],
            s_init=self.params["s_init"],
            lr_b=self.params["lr_b"],
            lr_w=self.params["lr_w"],
            lr_s=self.params["lr_s"],
            weights=None,
        )
    ...
    def predict(self, X: np.ndarray, clip: bool = False) -> np.ndarray:
        ...
        return PredictQuadraticNeuronART(
            X_,
            rho=self.params["rho"],
            s_init=self.params["s_init"],
            lr_b=self.params["lr_b"],
